            ...
            if (this.props.allProducts != '') {
                ...
                showQty = () => {
                        ...
                        if (this.state.form.productQty != 0 || this.state.form.productQty != 'none') {
                            ...
                            clickedSaveItemBtn = () => {
                                const { allProducts, form, addItemToList, closePopup } = this.props;

                                const selectedProduct = allProducts.find(product => product.id === form.product);
                            ...
                            render() {
                                return ( <
                                    ...
                                    <
                                    option value = "none" > Select A Sneaker < /option> { this.showProducts() } <
                                    /select> <
                                    /div> <
                                    div className = "form-group" >
                                    <
